...
- [Architecture Review Evidence](docs/agents/architecture-review-evidence.md) — each rule grounded in a real reference + its lint enforcement (what's machine-checked vs. manual)
