...
# lsof is used instead of netstat: macOS netstat output has variable spacing
# ("127.0.0.1.5554   *.*  LISTEN") that causes the netstat grep to never
# match, so PORT never increments and every call picks 5554.
PORT=5554
